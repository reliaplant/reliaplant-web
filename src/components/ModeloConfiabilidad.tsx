    ...
    return (
        <div className="px-[8vw] my-12">
            ...
            <Image src={modelArrows} alt="Criticidad" layout="fill" className="absolute z-100 skeleton-loading"/>
                ...
                <div className="p-[4vw] px-[6vw] relative w-full h-[42vw] grid grid-cols-4 gap-[4vw] gap-y-[3vw] borderIA shadow-md rounded-lg relative">

                <button className="h-fit z-200 absolute right-[12px] bottom-[12px] ">Conoce como iniciar </button>
                    ...
                    <div className="w-[100%] h-[15vw] flex flex-col items-center justify-center text-center p-[1vw] bgIA">
                        ...
                        <span className="text-[0.5vw] text-gray80">
                            Registro, Documentación y Resolución de Fallas <br /> repetitivas y catastróficas
                        </span>
                    </div>


                    <div className="flex flex-col w-[100%] h-[15vw] flex items-center justify-center bgIA bg-red20 animation-delay-2500">
                        ...
                        <div className="flex flex-col items-center justify-center text-center w-full h-full gap-2 p-[1vw]">
                            <div className="flex flex-col p-[.0vw] w-full h-full gap-1">
                                <div className="text-[0.5vw] flex flex-col items-center justify-center text-blue60 font-bold">AMEF</div>
                            ...
                            <div className="flex flex-col p-[0vw] w-full h-full gap-1">
                                <div className="text-[0.5vw] flex flex-col items-center justify-center text-blue60 font-bold">Consecuencias</div>
                                <div className="flex flex-row gap2 w-full h-full gap-1">
                                    <div className="text-[0.5vw] leading-tight text-gray80 p-[.3vw] w-full h-full flex flex-col justify-center items-center text-center border-gray-700 bg-blue20">
                                        Oper.
                                    </div>
                            ...
                            <div className="flex flex-col p-[0vw] w-full h-full gap-1">
                                <div className="text-[0.5vw] flex flex-col items-center justify-center text-blue60 font-bold ">Actividades</div>
                                <div className="flex flex-row gap2 w-full h-full gap-1">
                                    <div className="text-[0.5vw] leading-tight text-gray80 p-[.3vw] w-full h-full flex flex-col justify-center items-center text-center border-gray-700 bg-blue20">
                                        Predictivo
                                    </div>
                        ...
                        <div className="flex flex-col items-center justify-center text-center gap-1 h-[3vw] p-[1vw] mb-[1vw]" >
                            ...
                            <span className="text-[0.5vw] text-gray80">
                                Generación de planes de Mantenimiento Por Familia y Tipo de Equipo. Procedimientos de Trabajo (mtto)
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="w-[100%] h-[15vw]  flex flex-col items-center justify-center text-center p-[0.5vw] bgIA  animation-delay-500">
                        <div className="flex flex-col justify-start mt-[0.5vw]">
                            <div className="font-bold text-start text-blue60 text-[0.5vw]"><span className="text-green1">PA-5200:</span> Sistema de compresión </div>
                            <div className="pl-[1vw] text-start text-gray80 text-[0.5vw]"><span className="text-green1">TC-5200:</span> Turbocompresor </div>
                            <div className="pl-[2vw] text-start text-gray80 text-[0.5vw]"><span className="text-green1">GB-5200:</span> Compresor centrífugo </div>
                            <div className="pl-[2vw] text-start text-gray80 text-[0.5vw]"><span className="text-green1">TB-5200:</span> Turbina a gas </div>
                            <div className="pl-[2vw] text-start text-gray80 text-[0.5vw]"><span className="text-green1">FG-5200A:</span> Filtro de gas combustible </div>
                            <div className="pl-[2vw] text-start text-gray80 text-[0.5vw]"><span className="text-green1">FG-5200B:</span> Filtro de gas combustible </div>
                            <div className="pl-[2vw] text-start text-gray80 text-[0.5vw]"><span className="text-green1">ME-5200:</span> Motor de arranque </div>

                            <div className="mt-[1vw] font-bold text-start text-blue60 text-[0.5vw]"><span className="text-green1">PA-6100:</span> Sistema de bombeo </div>
                            <div className="pl-[2vw] text-start text-gray80 text-[0.5vw]"><span className="text-green1">PB-6100A:</span> Bomba centrífuga </div>
                            <div className="pl-[3vw] text-start text-gray80 text-[0.5vw]"><span className="text-green1">ME-6100A:</span> Motor eléctrico </div>
                            <div className="pl-[2vw] text-start text-gray80 text-[0.5vw]"><span className="text-green1">PB-6100B:</span> Bomba centrífuga </div>
                            <div className="pl-[3vw] text-start text-gray80 text-[0.5vw]"><span className="text-green1">ME-6100B:</span> Motor eléctrico </div>
                        </div>
                        <span className="text-[1vw] font-normal text-gray80">
                            Registro de Activos
                        </span>
                    ...
                    <div className="w-[100%] h-[15vw]  flex flex-col items-center justify-center text-center p-[0.5vw] bgIA  animation-delay-1500">
                        ...
                        <span className="text-[0.5vw] text-gray80">
                            Evaluación de importancia e impacto de sistemas <br /> y equipos a la S, A & Op.
                        </span>
                    </div>
                    ...
                    <div className="w-[100%] h-[15vw]  flex flex-col items-center justify-center text-center p-[0.5vw] bgIA  animation-delay-2000">
                        ...
                        <span className="text-[0.5vw] text-gray80">
                            Procesamiento y ajuste de datos de falla y <br /> reparación para el análisis cuantitativo.
                        </span>
                    </div>
                    ...
                    <div className=" w-[100%] h-[15vw] flex flex-col items-center justify-center text-center p-[1vw] bgIA  animation-delay-2500" >
                        ...
                        <span className="text-[0.5vw] text-gray80">
                            Número óptimo de repuestos, Smin, Smax, Stock de Seguridad, LEP para repuestos de alta y baja rotación.
                        </span>
                    </div>
                    ...
                    <div className=" w-[100%] h-[15vw]   flex flex-col items-center justify-center text-center p-[1vw] bgIA  animation-delay-500">
                        ...
                        <span className="text-[0.5vw] text-gray80">
                            Evaluación de Metas de Confiabilidad, Disponibilidad, Mantenibilidad y Producción.
                        </span>
                    </div>
                    ...
                    <div className="w-[100%] h-[15vw]    flex flex-col items-center justify-center text-center p-[1vw] bgIA">
                        ...
                        <span className="text-[0.5vw] text-gray80">
                            Optimización Costo Riesgo Beneficio y Estudios de Análisis de Costo de
                            Ciclo de Vida (LCC)                </span>
                    </div>
                </div>
            </div>
        </div>
