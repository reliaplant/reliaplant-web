...
export function FinalBanner() {
  return (
    <div className="px-4 md:px-[4vw] py-12 md:py-0 bg-gradient-to-r from-gray-50 to-blue-50">
      <div className="flex flex-col md:flex-row bg-white justify-between overflow-hidden hover:shadow-xl transition-all duration-300">
        <div className="p-8 md:p-[4vw] w-full md:w-1/2">
          ...
          <div className="mt-8 md:mt-12">
            <Link
              href="#contacto"
              className="inline-flex items-center gap-3 bg-gray-900 hover:bg-blue-600 text-white px-6 py-3.5 font-medium transition-colors"
            >
