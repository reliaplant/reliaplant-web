  ...
  return (
    <>
      <style>{`
        ...
        .rcma-t col.c1 { width:20%; }
        .rcma-t col.c2 { width:15%; }
        .rcma-t col.c3 { width:18%; }
        .rcma-t col.c4 { width:20%; }
        .rcma-t col.cr { width:4.5%; }
        .rcma-t col.cnpr { width:7%; }
        ...
        <div className="rcma-tw">
          <table className="rcma-t">
            <colgroup>
              ...
              <col className="cr" /><col className="cr" /><col className="cr" /><col className="cnpr" />
            </colgroup>
