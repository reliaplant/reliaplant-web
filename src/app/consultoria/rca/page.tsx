...
import { Query, Share, Subflow, Warning, ArrowUpRight, Industry, Activity, EventWarning, TransformInstructions, ArrowRight, RequestQuote, SupportVectorMachine, DataAnalytics, Headset, Number_1, Number_2, Number_3, Number_4, QuestionAnswering, TreeView, DataVolume, SyncSettings, Inspection } from '@carbon/icons-react';
import { CheckCircle2, FileSearch, Users, GitBranch, ClipboardList, FileSymlink, ArrowRight as ArrowRightLucide, Layers, Target, Microscope, AlertCircle, Check, LineChart, BookOpen } from "lucide-react";

export const metadata: Metadata = {
    title: {
        absolute: "Análisis de Causa Raíz (RCA) para Eliminación de Defectos | RELIAPLANT",
    },
    description: "Servicios especializados de investigación y análisis de causa raíz para eliminar defectos recurrentes e incidentes en equipos industriales.",
}
        ...
        <div>
                        ...
                        <div>
                            <div className="flex flw-row">
                                <span className="text-blue60 font-light">
                                    Inicio <span className="mx-2 text-gray60">{'/'}</span> Consultoria <span className="mx-2 text-gray60">{'/'}</span> Análisis RCA
                                </span>
                            </div>
                            <h1 className="text-6xl font-light text-black">Análisis de Causa Raíz para Eliminación de Defectos</h1>
            ...
            <div className="mt-16 px-[8vw]">
                <div className="flex flex-row gap-16">
                    <div className="w-1/2">
                        <h2 className="text-4xl font-light mb-8">La diferencia entre tratar síntomas y resolver problemas</h2>
                        ...
                        <div className="mt-8 p-6 bg-gray10">
                            <h3 className="text-xl font-medium mb-4">Fundamentos de nuestro enfoque</h3>
                            <div className="grid grid-cols-2 gap-4 mt-4">
                                <div className="flex items-start gap-3">
                                    <div className="w-2 h-2 bg-blue60 rounded-full mt-2 flex-shrink-0"></div>
                                    <p className="text-gray60">Basado en normas ASME, ISO 55000, API 689</p>
                                </div>
                                <div className="flex items-start gap-3">
                                    <div className="w-2 h-2 bg-blue60 rounded-full mt-2 flex-shrink-0"></div>
                                    <p className="text-gray60">Enfoque en evidencias verificables</p>
                                </div>
                                <div className="flex items-start gap-3">
                                    <div className="w-2 h-2 bg-blue60 rounded-full mt-2 flex-shrink-0"></div>
                                    <p className="text-gray60">Árbol Lógico de Fallas como método central</p>
                                </div>
                                <div className="flex items-start gap-3">
                                    <div className="w-2 h-2 bg-blue60 rounded-full mt-2 flex-shrink-0"></div>
                                    <p className="text-gray60">Análisis de factores técnicos y humanos</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-1/2 border">
                        <div className="p-8 bg-gray80 text-white">
                            <h3 className="text-2xl font-normal mb-6">¿Cuándo es necesario un RCA formal?</h3>
                        ...
                        <div className="p-8">
                            <ul className="space-y-4">
                                <li className="flex items-start gap-3">
                                    ...
                                    <p>Fallas recurrentes que persisten a pesar de las acciones correctivas implementadas.</p>
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="p-1 bg-blue60 text-white rounded-full flex-shrink-0 mt-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <p>Incidentes que provocan pérdidas económicas significativas, afectaciones a la seguridad o impactos ambientales.</p>
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="p-1 bg-blue60 text-white rounded-full flex-shrink-0 mt-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <p>Equipos críticos con patrones de falla inesperados o degradación acelerada.</p>
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="p-1 bg-blue60 text-white rounded-full flex-shrink-0 mt-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <p>Situaciones con potencial de escalamiento que podrían derivar en eventos catastróficos.</p>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div className="mt-24 px-[8vw] border-b sticky top-0 z-20">
                <div className="flex flex-row gap-4 justify-between">
                    <div className="flex flex-col justify-end">
                        <h2 className="border-b border-blue60 border-b-4 w-fit">Nuestra metodología</h2>
                    </div>
                </div>
            </div>
            ...
            <div className="px-[8vw] py-12">
                <div className="grid grid-cols-4 gap-6">
                    <div className="border p-6 pb-8 relative hover:shadow-lg transition-all duration-300">
                        ...
                        <h3 className="text-xl font-medium mb-3">Notificación y Preparación</h3>
                        ...
                        <div className="mt-4 pt-4 border-t border-gray20">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-sm">Preservación del lugar del evento</span>
                            </div>
                    ...
                    <div className="border p-6 pb-8 relative hover:shadow-lg transition-all duration-300">
                        ...
                        <h3 className="text-xl font-medium mb-3">Investigación y Análisis</h3>
                        <p className="text-gray60 mb-6">
                    ...
                    <div className="border p-6 pb-8 relative hover:shadow-lg transition-all duration-300">
                        ...
                        <h3 className="text-xl font-medium mb-3">Recomendaciones y Plan de Acción</h3>
                        <p className="text-gray60 mb-6">
                    ...
                    <div className="border p-6 pb-8 relative hover:shadow-lg transition-all duration-300">
                        ...
                        <h3 className="text-xl font-medium mb-3">Implementación y Seguimiento</h3>
                        <p className="text-gray60 mb-6">
            ...
            <div className="mt-16 px-[8vw]">
                <h2 className="text-4xl font-light mb-12 text-center">El poder del Árbol Lógico de Fallas</h2>
                
                <div className="flex flex-row gap-12 items-center">
                    <div className="w-1/2">
                        <div className="border p-8 bg-gray10">
                            <div className="flex justify-center">
                                <img src="/arbol-logico.png" alt="Diagrama de Árbol Lógico de Fallas" className="w-[80%] h-auto" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-1/2">
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-medium mb-2">Mapeo estructurado</h3>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-medium mb-2">Enfoque en la evidencia</h3>
                                    <p className="text-gray60">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-medium mb-2">Profundidad multinivel</h3>
                                    <p className="text-gray60">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-medium mb-2">Precisión cuantificable</h3>
                                    <p className="text-gray60">
            ...
            <div className="mt-24 px-[8vw] bg-gray80 text-white py-16">
                <h2 className="text-4xl font-light mb-12">Roles y responsabilidades en la investigación</h2>
                
                <div className="grid grid-cols-3 gap-6">
                    <div className="p-6 border border-gray60">
                        <Users size={32} className="text-blue60 mb-4" />
                        <h3 className="text-xl font-normal mb-3">Equipo Natural de Trabajo</h3>
                    ...
                    <div className="p-6 border border-gray60">
                        ...
                        <h3 className="text-xl font-normal mb-3">Responsables de Implementación</h3>
                        <p className="text-gray30">
            ...
            <div className="mt-16 px-[8vw]">
                <div className="grid grid-cols-2 gap-12">
                    <div className="border p-8">
                        <h3 className="text-2xl font-light mb-6">Herramientas y formatos especializados</h3>
                        <div className="space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-medium mb-1">Software de modelado de árboles lógicos</h4>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-medium mb-1">Matrices de recolección de evidencias</h4>
                                    <p className="text-gray60 text-sm">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-medium mb-1">Guías de entrevista especializada</h4>
                                    <p className="text-gray60 text-sm">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-medium mb-1">Laboratorio móvil de análisis</h4>
                                    <p className="text-gray60 text-sm">
                    ...
                    <div className="border p-8">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <p>Reducción de hasta un 85% en la recurrencia de fallas en equipos críticos.</p>
                            </div>
                            
                            <div className="flex items-start gap-3">
                                <div className="w-2 h-2 bg-blue60 rounded-full mt-2"></div>
                                <p>Disminución significativa de horas de mantenimiento no planificado.</p>
                            </div>
                            
                            <div className="flex items-start gap-3">
                                <div className="w-2 h-2 bg-blue60 rounded-full mt-2"></div>
                                <p>Optimización de procedimientos de operación y mantenimiento basados en hallazgos de las investigaciones.</p>
                            </div>
                            
                            <div className="flex items-start gap-3">
                                <div className="w-2 h-2 bg-blue60 rounded-full mt-2"></div>
                                <p>Desarrollo de capacidades internas para identificación temprana de condiciones de falla potencial.</p>
                            </div>
                            
                            <div className="flex items-start gap-3">
                                <div className="w-2 h-2 bg-blue60 rounded-full mt-2"></div>
                                <p>Transformación cultural hacia un enfoque basado en evidencias para la solución de problemas.</p>
                            </div>
                            
                            <div className="flex items-start gap-3">
                                <div className="w-2 h-2 bg-blue60 rounded-full mt-2"></div>
                                <p>Integración efectiva de las lecciones aprendidas en la gestión de activos y procesos.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="px-[4vw] bg-gradient-to-l from-blue60 to-gray10 mt-16">
                <div className="flex flex-row bg-gray20 justify-between hover:bg-white transition-all duration-100 hover:shadow-xl">
                    <div className="p-[4vw] w-[40vw]">
                        <h3 className="text-5xl font-light">¿Enfrentando fallas recurrentes o incidentes complejos?</h3>
                        <h4 className="mt-8 text-2xl font-normal">Nuestro equipo de especialistas en análisis RCA puede ayudarte a identificar las verdaderas causas y eliminarlas definitivamente.</h4>
                        <div className="mt-12" >
                            <button className="font-light text-[1.1rem] flex flex-row items-center gap-8 mb-4">
                                <span>
