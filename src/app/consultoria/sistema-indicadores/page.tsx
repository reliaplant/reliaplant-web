        ...
        <div className="mx-auto">
            ...
            <div className="contentSection">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white p-6 border relative flex flex-col h-full">
                        ...
                        <h4 className="font-semibold mb-4">Selección y definición de KPIs</h4>
                        <p className="text-gray70 flex-grow">
                    ...
                    <div className="bg-white p-6 border relative flex flex-col h-full">
                        ...
                        <h4 className="font-semibold mb-4">Implementación y capacitación</h4>
                        <p className="text-gray70 flex-grow">
            ...
            <div className="bg-gray-100 contentSection">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-white p-8 border relative border">
            ...
            <div className="contentSection">
                ...
                <div className="">
                    ...
                    <div className="flex items-start gap-8">
                        <div className="">
                            <h3 className="mb-6 mt-12">Elementos de la ficha del indicador</h3>
                            <ul className="">
            ...
            <div className="contentSection">
                ...
                <div className="border rounded-lg overflow-hidden border">
                    <div className="bg-blue10 text-white py-4 px-6">
                        <h4 className="font-bold !mb-0">Tiempo Medio de Reparación (MTTR)</h4>
                    ...
                    <div className="bg-white p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div className="mb-6">
                                    <h5 className="text-gray90 mb-2">Relación con otros indicadores</h5>
                                    <p className="text-gray70">
