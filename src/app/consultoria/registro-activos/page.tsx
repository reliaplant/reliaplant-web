        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4 sm:px-6 md:px-[3vw] lg:px-[5vw] ">
                <div className="border border-gray-200 p-6 md:p-8 rounded-sm flex flex-col justify-between">
                        ...
                        <p className="text-gray70 flex-grow">Diseña una taxonomía de activos para tu planta, desde los sistemas, equipos, subequipos y componentes.</p>
                    <div>
                ...
                <div className="border border-gray-200 p-6 md:p-8 rounded-sm flex flex-col justify-between">
                        ...
                        <p className="text-gray70 flex-grow">Creación de los datos técnicos maestros para los activos a nivel para todas las familias de equipo.</p>
                    <div>
                ...
                <div className="border border-gray-200 p-6 md:p-8 rounded-sm flex flex-col justify-between">
                        ...
                        <p className="text-gray70 flex-grow">Levantamiento fotográfico de los equipos para validación de los datos en campo mediante placa e inpsecciónes 360.</p>
                    <div>
                ...
                <div className="border border-gray-200 p-6 md:p-8 rounded-sm flex flex-col justify-between">
                        ...
                        <p className="text-gray70 flex-grow">Creación de los lineamientos para la modificación y creación del registro de activos siguiendo las políticas de la empresa.</p>
                    <div>
            ...
            <h2 className="mb-12">
                ...
                <div className="flex flex-col md:flex-row gap-8 md:gap-16 relative">
                    <div className="w-full md:w-1/2">
                        <div className="">
                            <h3 className="font-semibold">Revisión, Definición y Preparación</h3>
                        </div>
                        <div className="mt-6">
                            <ul className="list-disc pl-5 space-y-3 text-gray-600">
