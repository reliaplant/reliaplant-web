...
import { DocumentAdd, DocumentView, DocumentImport, RequestQuote, Template, Flow, CheckmarkOutline, Checkbox, ProgressBar, TextMining, TextLink, Edit, DataShare, Report, DocumentBlank, Headset } from '@carbon/icons-react';
