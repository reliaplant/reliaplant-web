        ...
        <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8 mt-8">
                        <div className="border p-6 flex flex-col justify-between h-[30vh]">
                            <div className="flex flex-col">
                                <span className="text-[1.4rem]">Definición de Responsabilidades</span>
                        ...
                        <div className="border p-6 flex flex-col justify-between h-[30vh]">
                            <div className="flex flex-col">
                                <span className="text-[1.4rem]">Planes de Formación Específicos</span>
                        ...
                        <div className="border p-6 flex flex-col justify-between h-[30vh]">
                            <div className="flex flex-col">
                                <span className="text-[1.4rem]">Integración con Sistemas de Gestión</span>
            ...
            <div className="px-4 md:px-16 py-[10vh] flex flex-col md:flex-row gap-8 md:gap-24">
                <div className="w-full md:w-1/2">
                    <h2 className="font-normal">Cerrando la brecha entre Recursos Humanos y Mantenimiento</h2>
                    <p className="text-lg leading-[136%] mt-4">
                        Las áreas de mantenimiento industrial enfrentan constantemente un desafío dual: por un lado, la necesidad de contar con personal especializado para cada tipo de equipo o sistema; por otro, la dificultad para definir claramente qué competencias exactas requiere cada puesto y cómo desarrollarlas.
                    </p>
                    <p className="text-lg leading-[136%] mt-4">
                        Nuestra metodología crea un puente entre Recursos Humanos y Mantenimiento, estableciendo un lenguaje común que permite:
                    </p>
                </div>
                <div className="w-full md:w-1/2">
                    <ul className="list-disc">
                        <li className="mb-2 text-xl">Definir con precisión qué debe saber hacer cada posición</li>
                        <li className="mb-2 text-xl">Clasificar las competencias como Obligatorias (O) o Deseables (D)</li>
                        <li className="mb-2 text-xl">Crear planes de desarrollo específicos para cada nivel y rol</li>
                        <li className="mb-2 text-xl">Establecer un sistema de certificación interna de habilidades</li>
                        <li className="mb-2 text-xl">Asegurar que el trabajo correcto sea asignado al técnico correcto</li>
                    </ul>
                </div>
            </div>
            ...
            <div className="px-4 md:px-16 bg-gray20 py-12">
                <div>
                    <div className="">
                        <h2 className="text-4xl font-light mb-8 text-center">Los Tres Pilares de la Matriz</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                            <div className="bg-white p-6 hover:shadow-lg transition duration-300 border border-gray30 h-[350px] flex flex-col">
                                ...
                                <h3 className="text-xl font-normal mb-2">1. Estructura de Responsabilidades</h3>
                                <p className="text-gray60 flex-grow">
                                    Define qué hace cada posición dentro del flujo de trabajo de mantenimiento:
                                </p>
                            ...
                            <div className="bg-white p-6 hover:shadow-lg transition duration-300 border border-gray30 h-[350px] flex flex-col">
                                ...
                                <h3 className="text-xl font-normal mb-2">2. Mapa de Competencias</h3>
                                <p className="text-gray60 flex-grow">
                            ...
                            <div className="bg-white p-6 hover:shadow-lg transition duration-300 border border-gray30 h-[350px] flex flex-col">
                                ...
                                <h3 className="text-xl font-normal mb-2">3. Plan de Formación</h3>
                                <p className="text-gray60 flex-grow">
                ...
                <div className="mt-24 flex flex-col md:flex-row gap-12">
                    <div className="w-full md:w-1/2">
                        <h2 className="text-3xl font-light mb-6">Ejemplo de Matriz de Competencias</h2>
                        <div className="overflow-x-auto">
                            <table className="min-w-full bg-white border">
                                ...
                                <tbody className="text-center">
                                    <tr>
                                        <td className="py-2 px-4 border font-medium text-left">Gerente de Mantenimiento</td>
                                    ...
                                    <tr>
                                        <td className="py-2 px-4 border font-medium text-left">Especialista en Confiabilidad</td>
                                        <td className="py-2 px-4 border bg-blue60 text-white">O</td>
                                        <td className="py-2 px-4 border bg-blue60 text-white">O</td>
                                        <td className="py-2 px-4 border">-</td>
                                        <td className="py-2 px-4 border bg-blue60 text-white">O</td>
                                    ...
                                    <tr>
                                        <td className="py-2 px-4 border font-medium text-left">Planificador de Mantenimiento</td>
                                        <td className="py-2 px-4 border bg-blue20">D</td>
                                        <td className="py-2 px-4 border">-</td>
                                        <td className="py-2 px-4 border">-</td>
                                        <td className="py-2 px-4 border bg-blue60 text-white">O</td>
                                    ...
                                    <tr>
                                        <td className="py-2 px-4 border font-medium text-left">Técnico Eléctrico</td>
                                        <td className="py-2 px-4 border">-</td>
                                        <td className="py-2 px-4 border bg-blue20">D</td>
                                        <td className="py-2 px-4 border bg-blue60 text-white">O</td>
                                        <td className="py-2 px-4 border bg-blue20">D</td>
                                    ...
                                    <tr>
                                        <td className="py-2 px-4 border font-medium text-left">Técnico Mecánico</td>
                                        <td className="py-2 px-4 border">-</td>
                                        <td className="py-2 px-4 border bg-blue60 text-white">O</td>
                                        <td className="py-2 px-4 border">-</td>
                                        <td className="py-2 px-4 border bg-blue20">D</td>
                    ...
                    <div className="w-full md:w-1/2">
                        <h2 className="text-3xl font-light mb-6">Categorías de Competencias que Mapeamos</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="border p-4 bg-white">
                                <h3 className="font-medium text-xl mb-3">Técnicas Fundamentales</h3>
                            ...
                            <div className="border p-4 bg-white">
                                <h3 className="font-medium text-xl mb-3">Metodologías de Confiabilidad</h3>
                                <ul className="list-disc pl-6 text-gray60">
                                    <li>RCM / FMEA</li>
                            ...
                            <div className="border p-4 bg-white">
                                <h3 className="font-medium text-xl mb-3">Normativas y Seguridad</h3>
                                <ul className="list-disc pl-6 text-gray60">
                                    <li>LOTO</li>
            ...
            <div className="mt-24 px-4 md:px-16 border-b ">
                <div className="flex flex-col md:flex-row gap-4 justify-between">
                    <div className="flex flex-col justify-end">
                        <h2 className="border-b border-blue60 border-b-4 w-fit">Nuestro Proceso</h2>
                    </div>
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-12">
                    <div className="w-full md:w-1/4 py-8 mb-16 border-black relative">
                        <div className="flex flex-row gap-4">
                            ...
                            <h3 className="font-normal text-lg">Diagnóstico organizacional y mapeo de estructura actual</h3>
                        </div>
                        ...
                        <div className="mt-4 leading-[136%]">
                            <ul className="list-disc pl-6">
                                <li>Revisión de estructura organizacional existente y descripciones de cargos</li>
                                <li>Identificación de todas las posiciones del área y sus interrelaciones</li>
                                <li>Levantamiento de prácticas actuales de mantenimiento y confiabilidad</li>
                                <li>Relevamiento de tecnologías y equipos críticos que requieren atención especializada</li>
                                <li>Entrevistas con líderes de RH y Mantenimiento para alinear expectativas</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="w-full md:w-1/4 py-8 mb-16 border-black relative">
                        <div className="flex flex-row gap-4">
                            ...
                            <h3 className="font-normal text-lg">Definición estratégica de responsabilidades y competencias</h3>
                        </div>
                        <div className="mt-8"></div>
                        <p className="text-lg leading-[136%]">
                            Establecemos el modelo integral de competencias y responsabilidades:
                        </p>
                        <div className="mt-4 leading-[136%]">
                            <ul className="list-disc pl-6">
                                <li>Creación del catálogo de competencias técnicas específicas para cada nivel</li>
                                <li>Definición detallada de responsabilidades para cada posición</li>
                                <li>Clasificación de competencias como Obligatorias (O) o Deseables (D)</li>
                                <li>Validación del modelo con equipos técnicos y de gestión</li>
                                <li>Diseño de la estructura matricial adaptada a la realidad operativa</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="w-full md:w-1/4 py-8 mb-16 border-black relative">
                        <div className="flex flex-row gap-4">
                            ...
                            <h3 className="font-normal text-lg">Implementación y desarrollo del plan formativo</h3>
                        </div>
                        <div className="mt-8"></div>
                        <p className="text-lg leading-[136%]">
                        ...
                        <div className="mt-4 leading-[136%]">
                            <ul className="list-disc pl-6">
                                <li>Construcción de la matriz completa con todos los roles y competencias</li>
                                <li>Evaluación de brechas entre competencias requeridas y existentes</li>
                                <li>Diseño del plan de formación individualizado por cargo y persona</li>
                                <li>Integración de la matriz en los sistemas de gestión (CMMS/ERP/RH)</li>
                                <li>Capacitación para líderes sobre uso y mantenimiento de la matriz</li>
                            </ul>
                        </div>
                    </div>
                    <div className="w-full md:w-1/4 p-8 mb-16 border-black relative bg-gray20">
                        <p className="text-lg leading-[136%]">
                            <strong>Resultado final:</strong> Una organización donde cada rol tiene claramente definidas sus responsabilidades y los conocimientos necesarios para cumplirlas, con un plan estructurado para desarrollar las competencias faltantes y mejorar continuamente el desempeño del área.
                        </p>
                    </div>
                </div>
            </div>
