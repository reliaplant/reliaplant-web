...
export const metadata: Metadata = {
  ...
  description:
    "Servicio de acompañamiento continuo para la optimización de mantenimiento y confiabilidad, adaptado a tus necesidades cambiantes.",
  keywords: [
    "asesoría continua",
        ...
        <div className="flex flex-col md:flex-row gap-16">
          <div className="w-full md:w-1/2">
            ...
            <p className="leading-[136%] mb-6">
              La gestión de la confiabilidad y el mantenimiento es un proceso
              continuo, no un destino. A medida que tu organización evoluciona,
              surgen nuevos desafíos técnicos, oportunidades de mejora y
              necesidades de optimización.
            </p>
            <p className="leading-[136%] mb-6">
              Nuestro servicio de Asesoría Continua establece una relación de
              largo plazo donde nos convertimos en una extensión de tu equipo,
              acompañándote para resolver problemas emergentes, optimizar
              procesos existentes, y ejecutar nuevas iniciativas según vayan
              surgiendo.
            </p>
            ...
            <div className="p-8 px-0 pr-4">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Quieren avanzar en su gestión de confiabilidad pero no
                    tienen claro por dónde empezar o cómo priorizar iniciativas.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="p-1 bg-blue60 text-white rounded-full flex-shrink-0 mt-1">
                  ...
                  <p>
                    Buscan una extensión flexible de su equipo técnico con
                    expertise especializado que sería costoso mantener
                    internamente.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Desean implementar mejoras graduales y sostenibles, sin la
                    disrupción de grandes proyectos de consultoría.
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="p-1 bg-blue60 text-white rounded-full flex-shrink-0 mt-1">
                  ...
                  <p>
                    Prefieren un modelo de costos predecible con resultados
