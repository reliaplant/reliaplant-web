    ...
    return (
        <div>
            ...
            <div className="mt-12 md:mt-24 px-4 sm:px-[8vw] flex flex-col md:flex-row md:gap-12 lg:gap-24">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-light w-full md:w-1/2 mb-6 md:mb-0">Optimiza las decisiones de inversión con base en el ciclo de vida de tus activos.</h3>
                <div className="w-full md:w-1/2">
                    <p className="mt-0 md:mt-4 text-gray60">Conoce cómo el análisis de Vida Útil Remanente (RUL) y Costo de Ciclo de Vida (LCC) puede ayudarte a determinar el momento óptimo para reemplazar o modernizar tus activos. Este enfoque integral combina evaluaciones técnicas de confiabilidad con análisis económicos para tomar decisiones informadas sobre la gestión de activos a largo plazo.</p>
                </div>
            </div>
            ...
            <div className="pt-8 md:pt-16 px-4 sm:px-[8vw]">
                <div className="bg-gray10 p-4 border">
                    <p className="mb-0 text-sm md:text-base">
                        <strong>Las principales razones para el fin de la vida útil de un activo incluyen obsolescencia, cambios del contexto operacional, incumplimiento de regulaciones, fin de vida física y fin de vida económica.</strong>
                        El análisis RUL y LCC permite identificar el momento óptimo para reemplazar o modernizar activos, optimizando inversiones y reduciendo riesgos operativos. <a href="" className="text-blue60">Leer guía sobre análisis de ciclo de vida</a> </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 px-4 sm:px-[8vw] mt-12 md:mt-24">
                <div className="border p-4 flex flex-col justify-between h-auto min-h-[200px] md:h-[25vh]">
                    <div className="flex flex-col">
                        <span className="text-xl md:text-[1.4rem]">Evalúa obsolescencia y cambios</span>
                        <span className="text-gray60 text-sm md:text-base">Identifica activos que ya no cuentan con repuestos o que no pueden adaptarse a nuevas condiciones operativas.</span>
                    </div>
                    <div className="mt-4">
                ...
                <div className="border p-4 flex flex-col justify-between h-auto min-h-[200px] md:h-[25vh]">
                    <div className="flex flex-col">
                        <span className="text-xl md:text-[1.4rem]">Optimiza inversiones</span>
                        <span className="text-gray60 text-sm md:text-base">Define el momento económicamente óptimo para la modernización o reemplazo de activos críticos.</span>
                    </div>
                    <div className="mt-4">
                ...
                <div className="border p-4 flex flex-col justify-between h-auto min-h-[200px] md:h-[25vh]">
                    <div className="flex flex-col">
                        <span className="text-xl md:text-[1.4rem]">Análisis económicos avanzados</span>
                        <span className="text-gray60 text-sm md:text-base">Evaluación de TIR, VPN y CAE para diferentes horizontes económicos de inversión.</span>
                    </div>
                    <div className="mt-4">
                ...
                <div className="border p-4 flex flex-col justify-between h-auto min-h-[200px] md:h-[25vh]">
                    <div className="flex flex-col">
                        <span className="text-xl md:text-[1.4rem]">Evaluación de escenarios</span>
                        <span className="text-gray60 text-sm md:text-base">Compara múltiples escenarios de operación continua vs. inversión en reemplazo o modernización.</span>
                    </div>
                    <div className="mt-4">
            ...
            <div className="mt-12 md:mt-24 px-4 sm:px-[8vw] border-b bg-white">
                <div className="flex flex-row gap-4 justify-between py-2">
                    <div className="flex flex-col justify-end">
                        <h2 className="border-b border-blue60 border-b-4 w-fit text-xl md:text-2xl">Metodología RUL y LCC</h2>
                    </div>
                    <div className="">
                        <AbrirFormContacto
                            buttonText="¿Dudas?"
                ...
                <div className="p-4 md:p-8 mb-8 md:mb-16 border-black flex flex-col md:flex-row md:gap-12 lg:gap-24 relative">
                    <div className="w-full md:w-1/2 mb-6 md:mb-0">
                        ...
                        <p className="text-base md:text-lg leading-relaxed md:leading-[136%]">
                            Esta metodología permite estimar la confiabilidad y disponibilidad de los activos a través de simulaciones basadas en datos históricos y estándares industriales. Utilizamos modelos de Diagrama de Bloques de Confiabilidad (RBD) para:
                        </p>
                        <ul className="list-disc mt-4 leading-relaxed md:leading-[136%] text-sm md:text-base">
                            <li>Simular y calcular indicadores RAM como confiabilidad, disponibilidad y mantenibilidad.</li>
                            <li>Caracterizar bloques con funciones de distribución de Tiempo Para Falla (TPF) y Tiempo Para Reparar (TPR).</li>
            ...
            <div className="px-4 sm:px-[8vw]">
                <div className="p-4 md:p-8 border-t mb-8 md:mb-16 border-black flex flex-col md:flex-row md:gap-12 lg:gap-24 relative">
                    <div className="w-full md:w-1/2 mb-6 md:mb-0">
                        ...
                        <div className="mt-4 md:mt-8"></div>
                        <p className="text-base md:text-lg leading-relaxed md:leading-[136%]">
                            Evaluamos los costos asociados a la operación, mantenimiento y reemplazo de activos a lo largo de distintos horizontes económicos (5, 10, 15 y 20 años). Esto nos permite realizar:
                        </p>
                        <ul className="list-disc mt-4 leading-relaxed md:leading-[136%] text-sm md:text-base">
                            <li>Simulación de costos operativos y de mantenimiento para diferentes horizontes económicos.</li>
                            <li>Definición de perfiles operativos y límites técnicos para los activos.</li>
            ...
            <div className="px-4 sm:px-[8vw]">
                <div className="p-4 md:p-8 border-t mb-8 md:mb-16 border-black flex flex-col md:flex-row md:gap-12 lg:gap-24 relative">
                    <div className="w-full md:w-1/2 mb-6 md:mb-0">
                        ...
                        <div className="mt-4 md:mt-8"></div>
                        <p className="text-base md:text-lg leading-relaxed md:leading-[136%]">
                            Para determinar la Vida Útil Remanente, comparamos dos escenarios fundamentales:
                        </p>
                        <ul className="list-disc mt-4 leading-relaxed md:leading-[136%] text-sm md:text-base">
                            <li>Escenario 1: Continuar operando los activos en su condición actual, siguiendo el programa de costos de inversión y operación establecido (Capex y Opex).</li>
                            <li>Escenario 2: Realizar inversiones para la modernización, rediseño o reemplazo de activos, identificando el momento óptimo para su sustitución.</li>
            ...
            <div className="px-4 sm:px-[8vw]">
                <div className="p-4 md:p-8 border-t mb-8 md:mb-16 border-black flex flex-col md:flex-row md:gap-12 lg:gap-24 relative">
                    <div className="w-full md:w-1/2 mb-6 md:mb-0">
                        ...
                        <div className="mt-4 md:mt-8"></div>
                        <p className="text-base md:text-lg leading-relaxed md:leading-[136%]">
                            Aplicamos estándares internacionales para la clasificación de los estimados según las prácticas recomendadas por la AACE International, considerando:
                        </p>
                        <ul className="list-disc mt-4 leading-relaxed md:leading-[136%] text-sm md:text-base">
                            <li>Consumo energético, mantenimiento programado y por falla, costos fijos operativos y pérdidas económicas por paradas.</li>
                            <li>Evaluación de los costos de inversión (Capex) y su retorno a lo largo del horizonte económico seleccionado.</li>
