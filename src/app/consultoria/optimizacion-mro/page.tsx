      ...
      <div className="px-[8vw] mt-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 bg-gray80">
          <div className="flex flex-col p-8">
            <h2 className="text-7xl font-light bg-gradient-to-r from-blue20 to-blue60 text-transparent bg-clip-text">
              40%
            </h2>
            ...
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc ml-6">
                ...
                <li>
                  ...
                  filosofía de operación (standby en frío, standby en caliente,
                  etc.) y factor de utilización de cada unidad.
                </li>
                <li>
            ...
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc ml-6">
                ...
                <li>
                  ...
                  (promedio, mínimo, máximo o bajo distribución probabilística)
                  y tiempo “premium” en caso de entregas urgentes.
                </li>
                <li>
                ...
                <li>
                  ...
                  terrestre), así como posibles seguros y tiempos de liberación
                  en puerto o fronteras.
                </li>
                <li>
            ...
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc ml-6">
                <li>
                  ...
                  (preparación de RFQ, análisis técnico-económico, aprobación y
                  colocación de ODC).
                </li>
                <li>
                ...
                <li>
                  Inspección y certificación: Costos asociados a revisiones que
                  el CLIENTE realice en las instalaciones del fabricante o en
                ...
                <li>
                  ...
                  activos en inventario, según la legislación local o nacional.
                </li>
              </ul>
            </div>
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc ml-6">
                <li>
                  Vida útil estimada: Considerar el envejecimiento en almacén y
            ...
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc ml-6">
                <li>
                  ...
                  tasa de rotación, costos, tiempos de entrega y situaciones de
                  obsolescencia.
                </li>
                <li>
            ...
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc ml-6">
                <li>
                  ...
                  disponibles cuando se necesitan, generan un impacto sustancial
                  en la producción.
                </li>
                <li>
                  <strong>Clase B:</strong> Repuestos de rotación media, con una
                  mezcla moderada de costo e impacto.
                </li>
                <li>
                  <strong>Clase C:</strong> Ítems de alta rotación y bajo costo
                  unitario, cuyo impacto en la producción puede ser menor o cuyo
                  lead time es muy corto.
                </li>
              </ul>
            </div>
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc ml-6">
                <li>
                  Costo de la indisponibilidad (impacto económico por detención
                  de equipos o pérdida de producción).
                </li>
                <li>
                  Costo del repuesto (adquisición, almacenamiento, transporte y
                  posibles sobrecostos en caso de entregas urgentes).
                </li>
                <li>
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc ml-6">
                ...
                <li>
                  Posibilidad de reparación o recuperación del ítem (si se trata
                  de repuestos que pueden reacondicionarse localmente).
                </li>
              </ul>
              <p className="mt-4">
                Mediante fórmulas o simulaciones (por ejemplo, en Excel con
                macros de Visual Basic, o con software especializado), se
                calcula el NOR para cada ítem crítico, comparando escenarios de
                costos y disponibilidad. El resultado indica:
              </p>
              <ul className="list-disc ml-6 mt-4">
                <li>Cuántas unidades es “óptimo” tener en stock.</li>
                <li>
                  Cuál es el riesgo asumido si se decide mantener menos piezas o
                  el costo extra si se almacena más de lo recomendado.
                </li>
              </ul>
            </div>
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc ml-6">
                <li>
                  ...
                  cubre la variabilidad de la demanda y el tiempo de reposición.
                </li>
                <li>
                ...
                <li>
                  ...
                  emite la orden de compra para reponer existencias, asegurando
                  no caer bajo el stock mínimo.
                </li>
              </ul>
        ...
        <div className="p-8 border-t mb-16 border-black flex flex-col md:flex-row gap-8 md:gap-24 relative">
          <div className="w-full md:w-1/2">
            ...
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc ml-6">
                <li>
                  Identificación de ítems en desuso o con riesgo de convertirse
                  en obsoletos, proponiendo acciones preventivas (por ejemplo,
                  buscar equivalencias o planes de reingeniería).
                </li>
              </ul>
            </div>
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc ml-6">
                <li>
                  ...
                  equipos o piezas que, por su alto valor, ameritan condiciones
                  especiales de protección contra humedad, corrosión u otras
            ...
            <p className="text-lg md:text-base leading-[136%] mt-4 p-4 bg-gray10">
              ...
              nuevos parámetros y puedan realizar ajustes periódicos en caso de
              cambios en la demanda o en la criticidad de los activos.
            </p>
          </div>
          <div className="w-full md:w-1/2">
        ...
        <div className=" flex flex-row bg-gray20 justify-between hover:bg-white transition-all duration-100 hover:shadow-xl">
          <div className="p-[4vw] w-[40vw]">
            <h3 className="text-5xl font-light">
              ¿Listo para optimizar tu inventario de repuestos?
            </h3>
            <h4 className="mt-8 text-2xl font-normal">
              Juntos, diseñaremos el Estudio de Optimización de Inventario que
              te permitirá incrementar la disponibilidad de tus activos y
              maximizar el valor de tu operación industrial.
            </h4>
            <div className="mt-12">
