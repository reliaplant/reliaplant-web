    ...
    return (
        <div>
            ...
            <div className="mt-12 md:mt-24 px-4 sm:px-[8vw] flex flex-col md:flex-row gap-8 md:gap-24">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-light w-full md:w-1/2">Evaluación de la disponibilidad de tus sistemas y equipos en tiempo record.</h3>
                <div className="w-full md:w-1/2">
                    <p className="text-gray60 text-sm sm:text-base">Conoce cómo el análisis RAM puede ayudarte a mejorar la confiabilidad de tus sistemas y equipos. La evaluación de la disponibilidad de tus sistemas y equipos te permite identificar áreas de mejora y optimizar el rendimiento operativo. Con el análisis RAM, puedes tomar decisiones informadas para aumentar la confiabilidad y eficiencia de tus procesos.</p>
            ...
            <div className="pt-8 md:pt-16 px-4 sm:px-[8vw]">
                <div className="bg-gray10 p-4 border text-sm sm:text-base">
                    <p className="mb-0">
                        <strong>El 80% de los costos en el ciclo de vida del proyecto de activos son OPEX. </strong>
                        El analisis ram permite identificar cuellos de botella que afectan la disponibilidad y mantenibilidad, para reducir los costos OPEX en el futuro, resultando en un costo de ciclo de vida total menor.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 px-4 sm:px-[8vw] mt-12 md:mt-24">
                <div className="border p-4 flex flex-col justify-between min-h-[220px] sm:h-[25vh]">
                    <div className="flex flex-col">
                        <span className="text-xl md:text-[1.4rem]">Evalúa instalaciones completas</span>
                        <span className="text-gray60 text-sm sm:text-base"> Modela sistemas complejos hasta instalaciones que se encuentran en fase de diseño.</span>
                    </div>
                    <div>
                ...
                <div className="border p-4 flex flex-col justify-between min-h-[220px] sm:h-[25vh]">
                    <div className="flex flex-col">
                        <span className="text-xl md:text-[1.4rem]">Aumenta la Disponibilidad</span>
                        <span className="text-gray60 text-sm sm:text-base"> Analiza la disponibilidad de tus sistemas y equipos para mejorar la eficiencia operativa.</span>
                    </div>
                    <div>
                ...
                <div className="border p-4 flex flex-col justify-between min-h-[220px] sm:h-[25vh]">
                    <div className="flex flex-col">
                        <span className="text-xl md:text-[1.4rem]">Identifica cuellos de botella</span>
                        <span className="text-gray60 text-sm sm:text-base"> Detecta y elimina los cuellos de botella en tus procesos para optimizar el rendimiento.</span>
                    </div>
                    <div>
                ...
                <div className="border p-4 flex flex-col justify-between min-h-[220px] sm:h-[25vh]">
                    <div className="flex flex-col">
                        ...
                        <span className="text-gray60 text-sm sm:text-base"> Implementa mejoras en el diseño de tus sistemas para aumentar la confiabilidad y eficiencia.</span>
                    </div>
                    <div>
                        <TransformInstructions size={48} className="text-blue60 md:size-[64px]" />
                    </div>
                </div>
            </div>
            ...
            <div className="mt-16 md:mt-24 px-4 sm:px-[8vw] border-b sticky top-0 z-20 bg-white">
                <div className="flex flex-col sm:flex-row gap-4 justify-between py-2">
                    <div className="flex flex-col justify-end">
                        <h2 className="text-xl md:text-2xl border-b border-blue60 border-b-4 w-fit">Proceso del Análisis RAM</h2>
                    </div>
            ...
            <div className="px-4 sm:px-[8vw]">
                ...
                <div className="p-4 sm:p-8 mb-8 md:mb-16 border-black flex flex-col md:flex-row gap-8 md:gap-24 relative">
                    <div className="w-full md:w-1/2">
                        ...
                        <p className="text-base sm:text-lg md:text-[1.15vw] leading-relaxed md:leading-[136%]">
                            En esta fase se recopila y analiza la documentación esencial para comprender en profundidad el sistema a evaluar. Se incluyen actividades como:
                        </p>
                        <ul className="list-disc mt-4 leading-relaxed md:leading-[136%] text-sm sm:text-base">
                            <li><strong>Revisión de Diagramas y Flujos</strong>: Se examinan los diagramas de flujo de procesos (PFD) y los diagramas de tuberías e instrumentación (DTI).</li>
                            <li><strong>Análisis de Hojas de Datos y Filosofía de Operación</strong>: Se revisan las hojas de datos de los equipos y se estudia la filosofía de operación.</li>
                ...
                <div className="p-4 sm:p-8 border-t mb-8 md:mb-16 border-black flex flex-col md:flex-row gap-8 md:gap-24 relative">
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="mt-4 md:mt-8"></div>
                        <p className="text-base sm:text-lg md:text-[1.15vw] leading-relaxed md:leading-[136%]">
                            Una vez recopilada la información, se definen los parámetros y criterios que determinarán la disponibilidad operativa del sistema:
                        </p>
                        <ul className="list-disc mt-4 leading-relaxed md:leading-[136%] text-sm sm:text-base">
                            <li><strong>Establecimiento de Parámetros y Umbrales</strong>: Se determinan los criterios de disponibilidad basados en normativas y fuentes técnicas.</li>
                            <li><strong>Construcción del Modelo RBD</strong>: Se desarrolla un diagrama de bloques de confiabilidad que representa la estructura del sistema.</li>
                ...
                <div className="p-4 sm:p-8 border-t mb-8 md:mb-16 border-black flex flex-col md:flex-row gap-8 md:gap-24 relative">
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="mt-4 md:mt-8"></div>
                        <p className="text-base sm:text-lg md:text-[1.15vw] leading-relaxed md:leading-[136%]">
                            En esta etapa se realiza una caracterización detallada de cada uno de los equipos que componen el sistema, lo que es fundamental para alimentar el modelo RBD con datos realistas:
                        </p>
                        <ul className="list-disc mt-4 leading-relaxed md:leading-[136%] text-sm sm:text-base">
                            <li><strong>Recopilación de Valores TTF y TTR</strong>: Se recaban los valores de Tiempo Hasta Fallo y Tiempo de Reparación.</li>
                            <li><strong>Selección de Distribuciones Probabilísticas</strong>: Se identifican las distribuciones que mejor se ajustan al comportamiento de cada equipo.</li>
                ...
                <div className="p-4 sm:p-8 border-t mb-8 md:mb-16 border-black flex flex-col md:flex-row gap-8 md:gap-24 relative">
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="mt-4 md:mt-8"></div>
                        <p className="text-base sm:text-lg md:text-[1.15vw] leading-relaxed md:leading-[136%]">
                            Con el modelo RBD construido y los equipos caracterizados, se procede a simular el comportamiento del sistema a lo largo de un horizonte operativo determinado:
                        </p>
                        <ul className="list-disc mt-4 leading-relaxed md:leading-[136%] text-sm sm:text-base">
                            <li><strong>Simulación Estocástica (Monte Carlo)</strong>: Se ejecutan múltiples corridas para evaluar la disponibilidad bajo diferentes escenarios.</li>
                            <li><strong>Análisis de Indicadores Clave</strong>: Se examinan indicadores como disponibilidad global, MTBDE, MDT y otros parámetros relevantes.</li>
