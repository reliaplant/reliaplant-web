    ...
    <div className="w-full">
      <div className="relative min-h-screen lg:h-[84vh] flex flex-col lg:flex-row items-center justify-start bg-cover bg-center bg-[url('/assets/fondo-landing-rcm.png')]">
        ...
        <div className="relative h-auto lg:h-full p-4 lg:p-8 bg-blue10 z-10 w-full lg:w-1/2 flex flex-col justify-center items-center">
          ...
          <p className="text-sm lg:text-base">
            ...
            Usando el Software de RCM-S de Reliaplant podrás crear y actualizar
      ...
      <div className=" flex flex-row gap-10 p-20 bg-gray90">
        <div className="w-full text-center min-h-[200vh]">
          ...
          >
            <div className="absolute left-[20%] top-[4%] w-[60%] h-[5%] flex items-center justify-center text-white text-lg font-bold text-[1.7vw]">
              PROCESO DE RCM OPTIMIZADO
            </div>
            ...
            <div
              className={`absolute left-[10%] top-[80%] w-[80%] h-[7%] flex flex-row gap-[2%] p-2 transition-all duration-500 ${
                activeSection === "5"
                  ? "bg-blue80 text-white scale-105"
                  : "bg-gray80"
              }`}
        ...
        <div className="w-full text-center ">
          ...
          <div
            className={`mt-[10vh] scroll-section mb-[10vh] transition-opacity duration-500 ${
              activeSection === "1" ? "opacity-100" : "opacity-25"
            }`}
            data-section="0"
          ></div>
          ...
          <div
            className={`mt-[35vh] scroll-section mb-[10vh] transition-opacity duration-500 ${
              activeSection === "1" ? "opacity-100" : "opacity-25"
            }`}
            data-section="1"
          >
            <div>
              ...
              <p className="text-white text-[0.9vw] text-left mb-10">
                ...
                sistema, tanto críticos como no críticos.
              </p>
            </div>
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to bottom, transparent 65%, #262626 100%)",
                }}
              ></div>
              ...
              <div className=" p-[1vw]">
                ...
                <p className="text-[0.6vw] text-left mb-4">
                  ...
                  que fue empleado en el sistema de enfriamiento de los empaques
                  y émbolos del hipercompresor. Cuenta con el calentador
                  eléctrico HE-1220, ubicado en el fondo del tanque, para
                ...
                <p className="text-[0.6vw] text-left mb-4">
                  ...
                  temperatura en el rango adecuado. Si la temperatura del aceite
          ...
          {/* ///////////////////////////////////////////// SEÒCION 2 //////////////////////////////// */}
          <div
            className={`mt-[25vh] scroll-section h-[80vh] mb-[10vh] transition-opacity duration-500 ${
              activeSection === "2" ? "opacity-100" : "opacity-25"
            }`}
            data-section="2"
          >
            <h3 className="text-white text-left font-black uppercase text-[1.4vw] mb-4">
            ...
            <p className="text-white text-[0.9vw] text-left mb-10">
              ...
              análisis se fundamenta en la experiencia y criterio del equipo de
              trabajo (ENT), respaldado por el historial relevante de fallas,
              que incluye la frecuencia de fallas (TPPF).
            </p>
            <div>
              <table>
                <thead>
          ...
          {/* ///////////////////////////////////////////// SEÒCION 2 //////////////////////////////// */}
          <div
            className={`mt-[25vh] scroll-section mb-[10vh] transition-opacity duration-500 ${
              activeSection === "3" ? "opacity-100" : "opacity-25"
            }`}
            data-section="3"
          ></div>

          <div
            className={`scroll-section transition-opacity duration-500 ${
          ...
          <div
            className={`mt-[25vh] scroll-section mb-[10vh] transition-opacity duration-500 ${
              activeSection === "4" ? "opacity-100" : "opacity-25"
            }`}
            data-section="4"
          >
            <h3 className="text-white text-left font-black uppercase text-[1.4vw] mb-4">
            ...
            <table>
              ...
              <tbody className="text-[0.6vw] text-gray90 bg-gray30">
                <tr>
                  <td>1</td>
                  <td>
                    Mala alimentación eléctrica (desbalance entre fases,
                    subtensiones, sobretensiones, o variación de frecuencia,
                    calidad de energía).
                  </td>
                  ...
                  <td>
                    Realizar monitoreo de vibración de espectro completo.
                    Establecer los niveles básicos y de acción. Analizar
                ...
                <tr>
                  <td>2</td>
                  <td>
                    Falla en caja de bornes por corrosión o humedad (genera
                    corto o circuito abierto).
                  </td>
                  <td className="text-center">Caja de conexiones</td>
                  <td>
                    UST (Spurious Stop); OHE (Overheating); FTS (Fail to start)
                  </td>
                  <td className="text-center">No</td>
                  <td className="text-center">Progresivo</td>
                  <td>
                    Realizar análisis de aceite lubricante básico. Establecer
                    niveles de acción. Analizar tendencias de los resultados.
                  </td>
                </tr>
                <tr>
                  <td>3</td>
                  <td>
                    Degradación del aislamiento por contaminación, humedad o
                    envejecimiento.
                  </td>
                  ...
                  <td className="text-center">Progresivo</td>
                  <td>
                    Inspección de los bornes y ajuste con torquímetro. Realizar
                    termografía.
                  </td>
                </tr>
                <tr>
                  <td>4</td>
                  <td>
                    Daño en el devanado por sobrecalentamiento o cortocircuito
                    interno.
                  </td>
                  <td className="text-center">Bobinados</td>
                  <td>OHE (Overheating)</td>
                  ...
                  <td className="text-center">Progresivo</td>
                  <td>
                    Realizar pruebas eléctricas (pruebas estáticas). Establecer
                    niveles de acción. Analizar tendencias de los resultados.
                  </td>
                </tr>
                <tr>
                  <td>5</td>
                  <td>
                    Falla o degradación de rodamiento por lubricación
                    deficiente.
                  </td>
                ...
                <tr>
                  <td>6</td>
                  <td>
                    Desalineación entre motor y carga, pata coja, soltura de
                    pernos o bastidor deteriorado.
                  </td>
                  <td className="text-center">
                    Pernos de fijación; base del motor
                  </td>
                  <td>VIB (Vibration)</td>
                  <td className="text-center">Sí</td>
                  <td className="text-center">Aleatorio</td>
                ...
                <tr>
                  <td>7</td>
                  <td>
                    Falla o degradación del eje (corrosión, fisura, fatiga,
                    deformación, desgaste por fricción).
                  </td>
                  ...
                  <td className="text-center">Progresivo</td>
                  <td>
                    Realizar una inspección visual interna. Desmontar y limpiar
                    según sea necesario.
                  </td>
                </tr>
                {/* <tr>
          ...
          <div
            className={`mt-[25vh] scroll-section mb-[10vh] transition-opacity duration-500 ${
              activeSection === "5" ? "opacity-100" : "opacity-25"
            }`}
            data-section="5"
          >
            <h3 className="text-white text-left font-black uppercase text-[1.4vw] mb-4">
            ...
            <table className="bg-gray30 text-[0.6vw]">
              ...
              <tbody>
                <tr>
                  <td
                    colSpan={10}
                    className="motor-header bg-gray60 text-gray20"
                  >
                    Motor Eléctrico ME-1202
                  </td>
                </tr>
                <tr>
                  <td>1</td>
                  ...
                  <td>
                    Verificar el funcionamiento de resistencias calefactoras
                    para la prevención de humedad en el interior del motor (solo
                    aplica cuando el motor no se encuentra operando, en standby
                    espera).
                  </td>
                  <td className="text-center bg-blue40">Operador</td>
                  <td className="bg-blue60"></td>
                  <td></td>
                  <td></td>
                  <td></td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td>
                    Verificar sensorialmente temperatura, vibración,
                    decoloración, olores y/o ruidos anormales.
                  </td>
                  <td className="text-center bg-blue40">Operador</td>
                  <td className="bg-blue60"></td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td>Mantenimiento Predictivo</td>
                  <td>
                    Verificar valores de tensiones y corrientes por fase,
                    potencia activa y reactiva, factor de potencia y
                    temperaturas.
                  </td>
                ...
                <tr>
                  ...
                  <td>Mantenimiento Predictivo</td>
                  <td>
                    Realizar análisis de vibración con analizador portátil.
                  </td>
                ...
                <tr>
                  ...
                  <td>Mantenimiento Preventivo</td>
                  <td>
                    Verificación conectada en caja (revisar con torquímetro que
                    tenga el torque requerido), inspección visual de acometida
                    en busca de cambios de coloración, sulfatación, pérdida del
                    aislamiento y presencia de humedad.
                  </td>
                  <td className="text-center bg-yellow40">Eléctrico</td>
                  <td></td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td>Mantenimiento Predictivo</td>
                  <td>
                    Pruebas estáticas (capacitancia, resistencia fase a fase,
                    desbalance resistivo, resistencia a tierra, inductancia fase
                    a fase, desbalance inductivo, índice de polarización, DAR,
                    prueba surge. Asegurar que el motor esté conectado, frío y
                    desenergizado).
                  </td>
                  <td className="text-center bg-yellow40">Eléctrico</td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    limpiar entradas y salidas de aire, deflectores y carcasa.
                  </td>
                ...
                <tr>
                  ...
                  <td>Mantenimiento Preventivo</td>
                  <td>
                    Verificación de alineación mecánica, nivelación, pata coja,
                    correcto apriete (torque) de pernos de anclaje.
                  </td>
                  <td className="text-center bg-red40">Mecánico</td>
                  <td></td>
                  <td></td>
          ...
          <div
            className={`mt-[25vh] scroll-section mb-[10vh] h-[100vh] transition-opacity duration-500 ${
              activeSection === "6" ? "opacity-100" : "opacity-25"
            }`}
            data-section="6"
          >
            <h3 className="text-white text-left font-black uppercase text-[1.4vw] mb-4">
            ...
            <table className="border border-gray-300 text-[0.5vw]">
              <thead className="">
                <tr className="">
                  ...
                  <th className=" text-center p-[0.2vw]">
              ...
              <tbody>
                <tr className="">
                  ...
                  <td className="bg-blue20 border-b-blue70">
                    ...
                    <ul className="list-disc pl-5 mt-1 text-gray-700">
                      <li>
                        Verificación conexionado en caja (revisar con
                        torquímetro que tenga el torque requerido), inspección
                        visual de acometida.
                      </li>
                      <li>
                        Limpieza del devanado con aire seco y desengrasante
                        dieléctrico.
                      </li>
                      <li>
                        Verificar el correcto conexionado eléctrico y sentido
                        del giro del motor.
                      </li>
                    </ul>
                  </td>
                ...
                <tr className="">
                  ...
                  <td className="bg-blue20 border-b-blue70">
                    ...
                    <ul className="list-disc pl-5 mt-1 text-gray-700">
                      <li>
                        Verificación de alineación mecánica, nivelación, pata
                        coja, correcto apriete (torque) de pernos de anclaje.
                      </li>
                      <li>
                        Verificación de acople (torque de apriete, elemento
                        flexible, juego axial y giro libre del eje).
                      </li>
                      <li>
                        Verificación del correcto funcionamiento del ventilador,
                        limpiar entradas y salidas de aire, deflectores y
                        carcasa.
                      </li>
                    </ul>
                  </td>
                ...
                <tr className="">
                  ...
                  <td className="border border-gray-300 bg-blue20 ">
                    ...
                    <ul className="list-disc pl-5 mt-1 text-gray-700">
                      ...
                      <li>
                        Inspección dimensional y de la integridad mecánica.
                      </li>
                      <li>
                        Reacondicionamiento y barnizado de estator y rotor
                        (pruebas eléctricas).
                      </li>
                    </ul>
                  </td>
      ...
      <div className="bg-blue10 flex flex-col items-center justify-center p-[7vh] pb-[3vh]">
        <div className="w-full bg-blue10 rounded-lg flex flex-col items-center justify-center p-[10vh] relative">
          ...
          <p>
            Habla con uno de nuestros expertos en RCM para conocer más sobre los
            servicios y software especializado.
          </p>
          <button
            className="bg-blue60 mt-4 text-xl"
            onClick={() => setShowModal(true)}
          >
