      ...
      <div className="mt-24 px-[8vw] flex flex-row gap-8">
          ...
          <div className="grid grid-cols-2 gap-8 mt-4">
            ...
            <div className="border p-4 flex flex-col justify-between h-[25vh]">
              <div className="flex flex-col">
                ...
                <span className="text-gray60">
                  Identificamos métodos de izaje adecuados y rutas seguras para
                  remover e instalar grandes componentes, optimizando costos y
                  reduciendo improvisaciones.
                </span>
              </div>
              <div>
            ...
            <div className="border p-4 flex flex-col justify-between h-[25vh]">
              <div className="flex flex-col">
                ...
                <span className="text-gray60">
                  ...
                  rediseño, proponiendo instalaciones que simplifiquen trabajos
        ...
        <div className="w-1/2">
          <div>
            ...
            <p className="text-[1.15vw] leading-[136%] mt-4">
              Optimizar la planificación de recursos y herramientas mediante un
              Material Handling Study (MHS) que determine métodos de izaje
              adecuados y rutas seguras.
            </p>
            <p className="text-[1.15vw] leading-[136%] mt-4">
              Mejorar la toma de decisiones en ingeniería y diseño (FEED/EPC) al
              integrar consideraciones de mantenibilidad desde etapas tempranas.
            </p>
            <p className="text-[1.15vw] leading-[136%] mt-4">
              Estandarizar soluciones de izaje y acceso, evitando
              improvisaciones en el día a día y disminuyendo costos logísticos y
              riesgos.
            </p>
            <p className="text-[1.15vw] leading-[136%] mt-4">
            ...
            <p className="text-[1.15vw] leading-[136%] mt-4">
              Complementar otras metodologías de confiabilidad como Análisis RAM
              y RCM para una visión holística de la operación.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="px-[8vw] mt-24">
        <div className="grid grid-cols-4 gap-8 bg-gray20">
          <div className="flex flex-col p-8 ">
            <h2 className="text-7xl font-light bg-gradient-to-r from-blue60 to-blue20 text-transparent bg-clip-text">
              30%
            </h2>
        ...
        <div className="border-t-2 bg-gray20">
          <div className="grid grid-cols-3 gap-8">
            <div className="flex flex-col items-center justify-center p-8 ">
              <h2 className="text-xl font-normal text-gray80">
              ...
              <div className="w-full mt-4">
                ...
                <div className="flex justify-between mt-2">
                  ...
                  <span className="text-gray70 font-light">
                    Manejo mecánico
                  </span>
                </div>
                <div className="w-full bg-gray-800 h-4">
      ...
      <div className="px-[8vw]">
        <div className="p-8 border-t mb-16 border-black flex flex-row gap-24 relative">
          <div className="w-1/2">
            ...
            <div className="mt-8"></div>
            <p className="text-[1.15vw] leading-[136%]">
              Con la información recopilada, definimos criterios claros para el
              análisis de mantenibilidad:
            </p>
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc">
                <li>
                  ...
                  pesos, dimensiones, frecuencia de mantenimiento y criticidad.
                </li>
                <li>
        ...
        <div className="p-8 border-t mb-16 border-black flex flex-row gap-24 relative">
          <div className="w-1/2">
            ...
            <div className="mt-4 leading-[136%]">
              ...
              <ul className="list-disc">
                <li>
                  Analizamos accesibilidad a puntos de inspección y componentes
                  críticos.
                </li>
                <li>
        ...
        <div className="p-8 border-t mb-16 border-black flex flex-row gap-24 relative">
          <div className="w-1/2">
            ...
            <p className="text-[1.15vw] leading-[136%] mt-4 p-4 bg-gray10">
              ...
              mantenimiento, facilitando su inclusión en sistemas CMMS como SAP
              PM o Maximo, y entregamos reportes claros con esquemas y planillas
              que ilustran cómo remover e instalar componentes de forma segura y
              eficiente.
            </p>
          </div>
