          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-start gap-3 text-gray-800 bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
            ...
            <div className="bg-red-50 border-l-4 border-red-400 p-8 rounded-xl">
