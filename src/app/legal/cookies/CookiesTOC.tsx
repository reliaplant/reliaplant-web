...
const toc = [
  ...
  { id: "tipos", label: "3. Cookies que utilizamos" },
  { id: "terceros", label: "4. Cookies de terceros" },
  { id: "base-legal", label: "5. Base legal según su ubicación" },
  { id: "gestionar", label: "6. Cómo gestionar las cookies" },
  { id: "no-vender", label: "7. Residentes de California (CCPA/CPRA)" },
