...
const toc = [
  ...
  { id: "ia", label: "6. Datos y el Asistente IA" },
  { id: "compartir", label: "7. Con quién compartimos datos" },
  { id: "retención", label: "8. Retención de datos" },
  { id: "seguridad", label: "9. Seguridad" },
  { id: "derechos", label: "10. Tus derechos" },
  { id: "cookies", label: "11. Cookies" },
  { id: "menores", label: "12. Menores de edad" },
  { id: "transferencias", label: "13. Transferencias internacionales" },
